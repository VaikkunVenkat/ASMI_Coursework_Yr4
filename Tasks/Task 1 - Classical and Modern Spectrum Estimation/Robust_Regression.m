...
grid on; grid minor; legend({'Noisy X', 'De-Noised X'},'FontSize',14);set(gca,'FontSize',18);
...
grid on; grid minor; legend({'Difference between true and de-noised X', 'Difference between de-noised and noisy X'},'FontSize',14);set(gca,'FontSize',18);
